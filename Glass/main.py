...
from Glass.core.brain import OrionBrain
from Glass.core.stt import SpeechToText
from Glass.core.tts import TextToSpeech
from Glass.core.calendar_manager import MacCalendar
from Glass.core.music_player import MusicPlayer
from Glass.core.wake_word import QueryClassifier
from Glass.self_dev.engine import SelfDevEngine
from Glass.core.work_assistant import WorkAssistant

# HUD와 서버는 Phase 2/3에서 활성화
try:
    from Glass.hud.renderer import HUDRenderer
    HUD_AVAILABLE = True
except ImportError:
    HUD_AVAILABLE = False
...
try:
    import uvicorn
    from Glass.server.app import create_app
...
class OrionO1:
    ...
    def __init__(self):
        ...
        # Work Assistant (hhheeelllppp 트리거)
        self.work_assistant = WorkAssistant(tts=self.tts)
        ...
        print(f"✅ Work Assistant: OK (hhheeelllppp)")
    ...
    def run(self):
        ...
        # Work Assistant 키보드 모니터링 시작
        self.work_assistant.start()
